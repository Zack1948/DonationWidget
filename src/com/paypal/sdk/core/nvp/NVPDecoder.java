...
/**
 * This class parses the String given in the NVP format and provides methods to
 * retrieve data in NVP format String.
 */
public class NVPDecoder {
	 ...
	 */
	private HashMap<String, String> nvp = new HashMap<String, String>();

	/**
	 * This method returns the value for the given Name key.
	 * 
	 * @param pName
	 *            The name for which the value is required
	 ...
	 * 
	 * @param pPayload
	 *            The string in the NVP format.
	 */
	public final synchronized void decode(String pPayload)
		...
		try {
			...
			while (stTok.hasMoreTokens()) {
				...
				if (stInternalTokenizer.countTokens() == 2) {
					nvp.put(URLDecoder.decode(stInternalTokenizer.nextToken(),
							ENCODE_TYPE), URLDecoder.decode(stInternalTokenizer
							.nextToken(), ENCODE_TYPE));
				}
			}
		} catch (Exception e) {
